...
/* ========= Conditonal rendering (#2) ======== */
//Setting the scene:
// We're starting a smoke test to start on the Tabs component
//Tabs.test.js  ===> App.js

/* ========= Conditonal rendering (#6) ======== */
//Render the first tab by default:
//This is a good point to make a snapshot test
// We can snapshot with the 1st tab showing default
//Added tabsProps at the top of test & create snapShot
//Tabs.test.js ===> RefactorTabs.js
